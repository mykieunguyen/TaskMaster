...
from projects.views import list_projects, project_detail, create_project, show_tagged_project, show_search_result, completed_projects, edit_project, delete_project
